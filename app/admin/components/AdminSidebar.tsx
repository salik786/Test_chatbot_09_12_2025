...
export default function AdminSidebar({ userEmail }: AdminSidebarProps) {
  ...
  return (
    <>
      {/* Mobile menu button */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-purple-100 px-4 py-3">
      ...
      >
        <div className="h-full flex flex-col bg-white/80 backdrop-blur-lg border-r border-purple-100 shadow-xl">
          {/* Logo */}
          ...
          <div className="p-4 border-t border-purple-100 space-y-3">
            ...
            <div className="space-y-2">
              <Link
                href="/chat"
                prefetch={true}
                className="flex items-center space-x-2 px-4 py-2 text-sm font-medium text-purple-600 hover:bg-purple-50 rounded-lg transition w-full cursor-pointer"
              >
